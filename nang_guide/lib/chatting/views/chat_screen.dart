...
import 'package:honbop_mate/chatting/controller/chat_room_controller.dart';
import 'package:honbop_mate/community/models/stomp_model.dart';
...
class ChatScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text(roomName, style: AppTextStyles.bodyLargeBold),
        leading: IconButton(
