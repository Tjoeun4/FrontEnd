...
void OcrDialog(BuildContext context) {
  ...
  final TextEditingController businessNumber2Controller =
      TextEditingController();
  final TextEditingController businessNumber3Controller =
      TextEditingController();
  final TextEditingController businessNumber4Controller =
      TextEditingController();
