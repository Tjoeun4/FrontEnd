...
import 'package:honbop_mate/community/controller/post_controller.dart';
              ...
              if (controller.selectedType.value == '공동구매' ||
                ...
                return Column(
                  ...
                  children: [
                    ...
                    InkWell(
                      onTap: () =>
                          _showCustomDateRangePicker(context, controller),
                      child: IgnorePointer(
                        child: TextField(
        ...
        return Theme(
          data: Theme.of(context).copyWith(
            colorScheme: const ColorScheme.light(
              primary: AppColors.primary, // 선택된 색상
