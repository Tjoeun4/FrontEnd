...
import 'package:honbop_mate/fridge/models/fridge_item_model.dart';
import 'package:honbop_mate/fridge/models/ingredient_create_request.dart';
import 'package:honbop_mate/fridge/models/ingredient_resolve_model.dart';
...
class FridgeApiService extends GetxService {
  ...
  // ============================================================
  Future<IngredientResolveModel?> resolveIngredient(
    String inputName,
    int userId,
  ) async {
    try {
      final response = await _dio.post(
        ...
        data: {'inputName': inputName, 'userId': userId},
      );
      if (response.statusCode == 200) {
  ...
  // ============================================================
  Future<FridgeItemModel?> createFridgeItem(
