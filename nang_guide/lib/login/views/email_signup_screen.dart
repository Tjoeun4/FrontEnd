...
import 'package:honbop_mate/login/views/address_search_page.dart';
...
class _EmailSignUpScreenState extends State<EmailSignUpScreen> {
  ...
  Future<void> _handleSendVerificationCode() async {
    ...
    if (success && mounted) {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(
          content: Text('인증번호 발송에 실패했습니다. 이메일 주소를 확인하거나 잠시 후 다시 시도해주세요.'),
        ),
      );
    }
  }
  ...
  Future<void> _handleVerifyCode() async {
    ...
    try {
      ...
      ScaffoldMessenger.of(
        context,
      ).showSnackBar(SnackBar(content: Text('인증 중 오류가 발생했습니다: $e')));
    }
  }
  ...
  Future<void> _checkNickname() async {
    ...
    bool isDuplicated = await _apiClient.checkNickname(
  ...
  void _searchAddress() async {
    ...
    if (result != null && result is Map<String, dynamic>) {
      ...
      if (sigungu != null && sigungu.isNotEmpty) {
        fetchedNeighborhoodId = await _apiClient.getNeighborhoodIdBySigungu(
          sigungu,
        );
      ...
      setState(() {
        ...
        _neighborhoodIdController.text =
            fetchedNeighborhoodId?.toString() ?? '지역 코드를 찾을 수 없습니다.';
      });
    }
  }
  ...
  Future<void> _submitForm() async {
    if (_formKey.currentState!.validate()) {
      ...
      final genderToSend = _selectedGender == '남자'
          ? 'M'
          : (_selectedGender == '여자' ? 'F' : null);
                  ...
                  suffix: Row(
                    ...
                    children: [
                      ...
                      SizedBox(
                        ...
                        child: _buildSmallButton(
                          '인증 확인',
                          _isVerified ? null : _handleVerifyCode,
                        ),
                      ),
                    ],
                  ),
                ...
                _buildTextField(
                  ...
                  validator: (value) {
                    if (value == null ||
                      ...
                      return '주소 검색을 통해 지역 코드를 설정해주세요.';
                    return null;
                  },
                ),
