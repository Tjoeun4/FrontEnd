...
class GoogleAuthService {
  ...
  static final GoogleSignIn _googleSignIn =
      GoogleSignIn.instance; // final은 항상 읽기 전용이라는 뜻인걸 인지하자
  ...
  static bool _initialized =
      false; // '_'를 붙여 private로 선언했다는 것은 이 변수를 이 GoogleAuthService 클래스 내부에서만 수정할 수 있다는 뜻
  ...
  static Future<void> initialize() async {
    ...
    try {
      await _googleSignIn.initialize(
        // GoogleSignIn패키지의 함수를 호출하여 serverClienId(백엔드 서버에서 구글 사용자임을 검증하는데 사용)를 등록
        serverClientId:
            '5963766792-o17ubta251bunv57riq2l5hss1lvhd45.apps.googleusercontent.com',
      );
      _initialized = true;
  ...
  GoogleSignInAccount? get currentUser =>
      _currentUser; // 예시 : 외부에서 authService.currentUser?.displayName; 이런식으로 접근
