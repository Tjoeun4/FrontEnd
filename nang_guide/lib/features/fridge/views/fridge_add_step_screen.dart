  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      bottomNavigationBar: Obx(() {
        ...
        if (res != null && (res.type == ResolveType.CONFIRM_ALIAS || res.type == ResolveType.AI_PENDING || controller.selectedItemId.value != null)) {
  ...
  Widget _buildNameInputStep() {
    ...
    return Padding(
      ...
      child: Column(
        ...
        children: [
          const Text("어떤 재료를 넣으시나요?", style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold)),
          ...
          TextField(
            ...
            decoration: InputDecoration(
              ...
              suffixIcon: IconButton(
                ...
                onPressed: () => controller.resolveIngredient(textController.text),
              ),
    ...
    return Column(
      children: [
        const Padding(
          ...
          child: Text("비슷한 재료가 있어요. 선택해주세요!", style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold)),
        ),
        Expanded(
        ...
        children: [
          if (isAi)
            Container(
              ...
              child: const Text("✨ 새로운 재료네요! AI가 유통기한을 분석해드릴게요.", style: TextStyle(color: Colors.blue)),
            ),
          Text(controller.displayItemName.value, style: const TextStyle(fontSize: 24, fontWeight: FontWeight.bold)),
          ...
          : GestureDetector(
              ...
              Expanded(
                child: TextField(
                  ...
                  decoration: const InputDecoration(hintText: "단위 (예: 개, g, 팩)"),
                ),
              ),
            ],
          ),
          ...
          const Text("구매일"),
          Obx(() => ListTile(
            title: Text("${controller.purchaseDate.value.year}-${controller.purchaseDate.value.month}-${controller.purchaseDate.value.day}"),
    ...
    return Padding(
      ...
      child: ElevatedButton(
        ...
        child: controller.isCreating.value
            ...
            : const Text("냉장고에 넣기", style: TextStyle(color: Colors.white, fontSize: 16, fontWeight: FontWeight.bold)),
      ),
    );
  }
}