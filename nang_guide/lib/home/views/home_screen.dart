...
import 'package:honbop_mate/home/controllers/home_controller.dart';
            ...
            children: [
              ...
              _buildFixedCard(
                ...
                content: Obx(() {
                  ...
                  return Column(
                    mainAxisAlignment:
                        MainAxisAlignment.spaceBetween, // 위아래 간격 배치
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      // 1. 식재료 리스트 영역
                      Column(
              ...
              _buildFixedCard(
                ...
                content: Obx(() {
                  ...
                  return Column(
                    mainAxisAlignment:
                        MainAxisAlignment.spaceBetween, // 💡 텍스트와 버튼을 위아래로 분리
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      // 1. 텍스트 영역
                      Padding(
                              ...
                              Row(
                                children: [
                                  Icon(
                                    ...
                                    size: 14,
                                    color: Colors
                                        .green[300], // 💡 카드 accentColor에 맞춘 색상
                                  ),
                                  const SizedBox(width: 4),
                                  Text(
                                    "가계부 바로가기",
