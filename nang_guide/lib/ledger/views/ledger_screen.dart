...
import 'package:honbop_mate/core/design/app_text_styles.dart';
import 'package:honbop_mate/core/dialog/expense_edit_screen.dart';
import 'package:honbop_mate/core/dialog/expense_registration_screen.dart';
...
import 'package:honbop_mate/ledger/controller/ledger_api_client.dart';
...
class LedgerScreen extends StatelessWidget {
            ...
            () => RichText(
              text: TextSpan(
                ...
                children: [
                  TextSpan(
                    text:
                        '${NumberFormat('#,###').format(controller.totalExpense.value)}원',
          ...
          children: [
            ...
            Row(
              ...
              children: [
                ...
                Text("연월 선택", style: AppTextStyles.bodyLargeBold),
                TextButton(
                  onPressed: () {
  ...
  Widget _buildHistoryTab() {
    final groupedData =
        controller.groupedItems; // 이제 Map<String, List<ExpenseResponse>> 타입임
  ...
  void _showDayDetailBottomSheet(int day) {
    ...
    var dayItems = controller.historyItems
        .where(
          (item) => DateFormat('yyyy-MM-dd').format(item.spentAt) == dateKey,
        )
        .toList();
      ...
      Container(
        ...
        child: Column(
          ...
          children: [
            ...
            Row(
              children: [
                Text('$day', style: AppTextStyles.heading2),
...
Widget _buildDayHeader(DateTime dateTime, int dayTotal) {
  return Container(
    ...
    child: Row(
      children: [
        Text('${dateTime.day}', style: AppTextStyles.heading2),
        const SizedBox(width: AppSpacing.sm),
        Column(
                ...
                Container(
                  ...
                  child: Text(
                    DateFormat(
                      'EEEE',
                      'ko_KR',
                    ).format(dateTime).substring(0, 1), // '수' 형태로 표시
